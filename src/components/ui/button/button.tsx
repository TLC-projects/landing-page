  ...
  'relative overflow-hidden text-sm text-center font-medium rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        outline: 'bg-transparent hover:bg-accent-100/20 border border-secondary-300 hover:text-accent-600 text-secondary-800 dark:text-white focus:ring-accent-500',
        ghost: 'bg-transparent hover:bg-accent-100/20 hover:text-accent-600 dark:text-white focus:ring-accent-500',
